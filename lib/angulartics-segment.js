! function(window, angular, undefined) {
  "use strict";
  angular.module("angulartics.segment", ["angulartics"]).config(["$analyticsProvider", function($analyticsProvider) {
    ...
    angulartics.waitForVendorApi("analytics", 1e3, "initialized", registerHandlers)
  }])
